		...
		<ul class="page-builder-ops">
			...
			<li class="inner-options pull-right">
				...
				<ul id="pagebuilder-templates">
					<li><a target="_blank" href="http://www.joomshaper.com/page-builder?aff_aid=agethemes">Availabe in Pro Version</a></li>
				</ul>
			</li>
			...
			<?php } ?>
			<li><a class="sppb-btn sppb-btn-danger" target="_blank" href="https://www.joomshaper.com/page-builder?aff_aid=agethemes"><?php echo JText::_('COM_SPPAGEBUILDER_UPGRADE_PRO'); ?></a></li>
			</ul>
		</div>
